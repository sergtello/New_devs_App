  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        ...
        const list: Property[] = result.data ?? [];
              ...
              <div className="flex flex-col sm:items-end">
                ...
                {error ? (
                  ...
                  <select
                    ...
                    className="block w-full sm:w-auto min-w-[200px] px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? (
